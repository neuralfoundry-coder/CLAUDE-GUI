# CLAUDE-EN.md - ClaudeGUI Project Conventions (English Mirror)

> This file is the English mirror of [`CLAUDE.md`](./CLAUDE.md). Both files must be updated together — see the [Bilingual Documentation Policy](#bilingual-documentation-policy) section below.

> **Bilingual documentation policy (MANDATORY)**: All documentation must be authored and kept in sync in both Korean (`CLAUDE.md`, `README.md`, `docs/srs/`, `docs/architecture/`) and English (`CLAUDE-EN.md`, `README-EN.md`, `docs/en/srs/`, `docs/en/architecture/`). A commit that updates only one language is considered incomplete. See the [Bilingual Documentation Policy](#bilingual-documentation-policy) section for details.
